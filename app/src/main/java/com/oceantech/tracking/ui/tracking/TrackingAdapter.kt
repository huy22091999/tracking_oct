...
//class TrackingAdapter (val context: Context, private val showMenu: (View, Tracking) -> Unit):PagingDataAdapter<Tracking, TrackingAdapter.TrackingHolder>(COMPARATOR){
//
//    class TrackingHolder(val context: Context, private val binding: ViewBinding):RecyclerView.ViewHolder(binding.root){
//        fun bindHolder(tracking: Tracking, showMenu:(View,Tracking)-> Unit) {
//            with(binding as ItemTrackingBinding){
//                trackingContent.text = tracking.content
//                trackingDate.text = formatDate(tracking.date.toString())
...
//
//    companion object {
//        private val COMPARATOR = object : DiffUtil.ItemCallback<Tracking>() {
...
//            holder.bindHolder(it, showMenu)
//        }
//    }
//
//    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TrackingHolder {
//        val itemBinding:ViewBinding = ItemTrackingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
//        return TrackingHolder(context,itemBinding)
//    }
//}